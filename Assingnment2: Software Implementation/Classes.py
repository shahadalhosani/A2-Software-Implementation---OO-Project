...
class Ticket: # create a class for the ticket
    def __init__(self, ticketNum, purchaseChoice, date, time, location, price=0): #define a constructor method to initialize the attributes of the ticket class.
        self.__ticketNum = ticketNum
        self.__purchaseChoice = purchaseChoice
        self.__date = date.today()
        self.__time = time
        self.__location = location
        self.__price = price #Initialize ticket price
